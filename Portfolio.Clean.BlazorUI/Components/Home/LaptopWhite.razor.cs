...
public partial class LaptopWhite
{
	...
	[Parameter]
	public string PositionBottom { get; set; } = string.Empty;
	[Parameter]
	...
	protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            module = await JSRuntime!.InvokeAsync<IJSObjectReference>("import", "./Components/Home/LaptopWhite.razor.js");
